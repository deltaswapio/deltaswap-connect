...
> Osmosis support is in beta, reach out to a Deltaswap contributor for early access.
...
See [theme.ts](https://github.com/deltaswapio/deltaswap-connect/blob/development/deltaswap-connect-loader/src/theme.ts) for examples

### 2. Add your config

Add a container div with the id `deltaswap-connect`. This is where the bridge will be rendered.

```html
<div id="deltaswap-connect" />
```
...
<script src="https://www.unpkg.com/@deltaswapio/deltaswap-connect@0.0.12/dist/main.js"></script>
<link
  href="https://www.unpkg.com/@deltaswapio/deltaswap-connect@0.0.12/dist/main.css"
/>
```

Note that the `deltaswap-connect` div with your config has to be present _before_ the scripts are loaded. If your application loads it after, you may need to add the scripts like this:

```js
function mount() {
  const script = document.createElement("script");
  script.src =
    "https://www.unpkg.com/@deltaswapio/deltaswap-connect@0.0.12/dist/main.js";
  script.async = true;

  const link = document.createElement("link");
  link.href =
    "https://www.unpkg.com/@deltaswapio/deltaswap-connect@0.0.12/dist/main.css";
...
const config: DeltaswapConnectConfig = {
  env: "mainnet",
...
function App() {
  return <DeltaswapBridge config={config} />;
}
```
