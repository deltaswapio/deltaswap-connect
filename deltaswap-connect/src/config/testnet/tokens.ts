...
export const TESTNET_TOKENS: TokensConfig = {
  ...
  WETH: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1vguuxez2h5ekltfj9gjd62fs5k4rl2zy5hfrncasykzw08rezpfs63pmq2',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  USDCeth: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1rl8su3hadqqq2v86lscpuklsh2mh84cxqvjdew4jt9yd07dzekyqkmcy3p',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  USDT: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1v2efcqkp2qtev06t0ksjnx6trxdd0f7fxg2zdrtzr8cr9wdpjkyqkv9ch6',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  DAI: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1uuwad4khwek2h05gmkktzmh8l4t0ep54yydlsqg0l4y2uh3tqfyq3an9k6',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  WMATIC: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1vhjnzk9ly03dugffvzfcwgry4dgc8x0sv0nqqtfxj3ajn7rn5ghq6whn2p',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCpolygon: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1qmk0v725sdg5ecu6xfh5pt0fv0nfzrstarue2maum3snzk2zrt5qcm4w3g',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  WBNB: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1335rlmhujm0gj5e9gh7at9jpqvqckz0mpe4v284ar4lw5mlkryzsnetfsj',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  WAVAX: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1tqwwyth34550lg2437m05mjnjp8w7h5ka7m70jtzpxn4uh2ktsmq8dv649',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCavax: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1qum2tr7hh4y7ruzew68c64myjec0dq2s2njf6waja5t0w879lutqv2exs9',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  WFTM: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1808lz8dp2c39vhm9gnemt7zzj95nvrmjepxp7v3w4skzrlyzcmnsxkduxf',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  CELO: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1e8z2wjelypwxw5sey62jvwjyup88w55q3h6m0x8jtwjf6sx5c7ys4mzydk',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  WGLMR: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap10sfpr8ykh9xn93u8xec4ed3990nmvh86e0vaegkauqhlkxspysyqwavrxx',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  WSOL: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1gryz69gzl6mz2m66a4twg922jtlc47nlx73sxv88lvq86du5zvyqz3mt23',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCsol: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1ced9v4plkf25q8c6k9gz0guq6l4xyjujpjlvxfg8lpaqywkmamashswq7p',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  SUI: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1yf4p93xu68j5fseupm4laj4k6f60gy7ynx6r5vvyr9c0hl3uy8vqpqd6h0',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  APT: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1u8rft0gee23fa6a0t4t88ualrza5lj8ses4aur0l66c7efpvjezqchv34j',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  WETHarbitrum: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap186k0cp83c3wyvapgh8fxf66ededemzrfujvjfsx0xw3vr0u9g8sq2y30vx',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCarbitrum: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1s3pk90ccfl6ueehnj8s9pdgyjjlspmr3m5rv46arjh5v4g08dd0qrchjrk',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  WETHoptimism: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap12eu6c7f67l8gdl2lt0hz0dgdh24dhune6wjgy5t0es3tpfzhc3yspwnpfy',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCoptimism: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1u5z7097gm57zvun9wqsx6jxej2gpdjhg9l9xfe58rhpm29rtjmfqfnl4yv',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  WETHbase: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap10p89p4zh00dwdg8h52sysrqm0l2j47jj3kmg93pnz2a039ucw7esgl5vl9',
        decimals: 8,
      },
      cosmoshub: {
        address:
  ...
  USDCbase: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1ja4txt6m0jjq0gmjtmv442f8wk0r5f5apaya0z55wwlrpg3p5xaq3qxw7h',
        decimals: 6,
      },
      cosmoshub: {
        address:
  ...
  wstETH: {
    ...
    foreignAssets: {
      deltachain: {
        address:
          'deltaswap1u2zdjcczjrenwmf57fmrpensk4the84azdm05m3unm387rm8asdsxqwfeu',
        decimals: 8,
      },
      cosmoshub: {
        address:
