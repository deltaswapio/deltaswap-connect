...
export const MAINNET_TOKENS: TokensConfig = {
  ...
  WETH: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap18csycs4vm6varkp00apuqlsm7v4twg8jsljk8wfdd7cghr7g4rtslwqndm',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  USDCeth: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1utjx3594tlvfw4375esgu72wa4sdgf0q7x4ye27husf5kvuzp5rsr72gdq',
        decimals: 6,
      },
      evmos: {
        address:
  ...
  WBTC: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1nz0r0au8aj6dc00wmm3ufy4g4k86rjzlr8wkf92cktdlps5lgfcqxnx9yk',
        decimals: 8,
      },
      evmos: {
        address:
  ...
  USDT: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1w27ekqvvtzfanfxnkw4jx2f8gdfeqwd3drkee3e64xat6phwjg0savgmhw',
        decimals: 6,
      },
      osmosis: {
        address:
  ...
  DAI: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1chejx4qqtvwxy6684yrsmf6pylancxqhk3vsmtleg5ta3zrffljqfscg87',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  BUSD: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1msyushf6d76u9wupuvm6jdvc0x4trmv5w5kxr0hyt7n9npp233usg7pkhm',
        decimals: 8,
      },
    },
  },
  ...
  WMATIC: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1xmpenz0ykxfy8rxr3yc3d4dtqq4dpas4zz3xl6sh873us3vajlpszn4ph7',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  USDCpolygon: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap19wut8ssulwasjquxpspfeq097kwj2n86fk3vq0g9c8eml2rqtprq97zy3e',
        decimals: 6,
      },
      evmos: {
        address:
  ...
  WBNB: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap169nr66h9gcsfljvsnxnqfjakskcjt6ac8f58wqjuagu79m540teqfvaal4',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  USDCbnb: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1g3acw7aumaj3r348cqn4kazrehlmn822w9p46sqwztnke27h3lysxj4ddr',
        decimals: 8,
      },
      evmos: {
        address:
  ...
  WAVAX: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1ml922hnp59jtq9a87arekvx60ezehwlg2v3j5pduplwkenfa68ksgmzxwr',
        decimals: 8,
      },
      kujira: {
        address:
  ...
  USDCavax: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1gwm6mrnse9atzf4mer4dnrz64mp6pa75wpsxywu8gymt9fwsk46sfr372u',
        decimals: 6,
      },
      kujira: {
        address:
  ...
  WFTM: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1e0cwfmla7exa578xddl87paxexw9ymwrzysfjms8c2mstxjkldlqn45jqa',
        decimals: 8,
      },
      evmos: {
        address:
  ...
  CELO: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1kqey3a6k26kyensq7elcpx229tlj4d3qlshwhjq5xjm8dcdvu60qtef8k9',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  WGLMR: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1gzuv84xrwwhxhf0f62av279vfyrfrm7x58fcnadlr5m90gnx223ses2st0',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  WSOL: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1wn625s4jcmvk0szpl85rj5azkfc6suyvf75q6vrddscjdphtve8sca0pvl',
        decimals: 8,
      },
      kujira: {
        address:
  ...
  USDCsol: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap17fr8awnysyv3nt5je4strczdupssl8u9jqam890jfv72sh32yyqqhtg3ry',
        decimals: 6,
      },
      osmosis: {
        address:
  ...
  SUI: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap19hlynxzedrlqv99v6qscww7d3crhl86qtd0vprpltg5g9xx6jk9q6ya33y',
        decimals: 8,
      },
      kujira: {
        address:
  ...
  APT: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1f9sxjn0qu8xylcpzlvnhrefnatndqxnrajfrnr5h97hegnmsdqhsh6juc0',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  WETHarbitrum: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap18nlwscr7290j463vcptqlgqudycry2rdnw2ysltpc2nqefk3353s808rl9',
        decimals: 8,
      },
      evmos: {
        address:
  ...
  WETHoptimism: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1ev8rhdflmlq6de5g7ttj585fhuv3jfhnuhfzyh7qrswhzaq2tkqswxz6y3',
        decimals: 8,
      },
    },
  },
  USDCoptimism: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1snw0qugpjcxwtxzzkqt5guwavq85eumxzeagql2u2m662xrtnjuqyj3pkj',
        decimals: 6,
      },
      aptos: {
        address:
  ...
  USDCbase: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1edkult6zudk6ld23fesjfrehux35q86engsq5jlycl0e4upkz8mqkgcprf',
        decimals: 6,
      },
      osmosis: {
        address:
  ...
  tBTC: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1nu9wf9dw384attnpu0pwfet5fajn05w2ex4r07mghvk3xcwrt2yq5uutp5',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  wstETH: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap1gg6f95cymcfrfzhpek7cf5wl53t5kng52cd2m0krgdlu8k58vd8qezy8pt',
        decimals: 8,
      },
      osmosis: {
        address:
  ...
  BONK: {
    ...
    foreignAssets: {
      ...
      deltachain: {
        address:
          'deltaswap10qt8wg0n7z740ssvf3urmvgtjhxpyp74hxqvqt7z226gykuus7eq9mpu8u',
        decimals: 5,
      },
      osmosis: {
        address:
