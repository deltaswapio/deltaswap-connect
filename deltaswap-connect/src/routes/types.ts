...
export type SignedDeltaswapMessage =
...
export type SignedMessage = SignedDeltaswapMessage | SignedCCTPMessage;

export const isSignedDeltaswapMessage = (
  message: SignedMessage,
): message is SignedDeltaswapMessage =>
