...
export const DeltaswapGatewayIdl: Idl = {
  version: '0.1.0',
  name: 'deltaswap_gateway',
  instructions: [
    {
      name: 'initialize',
      accounts: [
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isSigner: false,
          docs: [
            'This mint is owned by the Deltaswap Token Bridge program. This PDA address is stored in the',
            'custodian account.',
          ],
        },
        {
        ...
        },
        {
          ...
          docs: [
            ...
            'tBTC using the deposit_deltaswap_tbtc instruction.',
          ],
        },
        {
          name: 'tbtcConfig',
  ...
  errors: [
    ...
    },
    {
      ...
      msg: 'Not enough deltaswap tBTC in the gateway to bridge',
    },
    {
      code: 6080,
      name: 'ZeroAmount',
