import { Network as Environment, isEVMChain } from '@deltaswapio/deltaswap-sdk';
...
export const wh: DeltaswapContext = new DeltaswapContext(
  ENV as Environment,
  {
    ...sdkConfig,
    ...{ rpcs: RPCS },
...
export const solanaContext = (): SolanaContext<DeltaswapContext> => {
  return wh.getContext(MAINNET_CHAINS.solana) as SolanaContext<DeltaswapContext>;
};
