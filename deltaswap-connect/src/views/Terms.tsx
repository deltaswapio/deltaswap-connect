    ...
    <div className={classes.terms}>
      ...
      <div className={classes.body}>
        ...
        <div>
          ...
          "SDK") that overlays the Deltaswap protocol, a cross chain messaging
          protocol. THIS SDK AND THE DELTASWAP PROTOCOL ARE MADE AVAILABLE "AS
          IS", AT YOUR OWN RISK, AND WITHOUT WARRANTIES OF ANY KIND. By using or
          accessing this SDK or the Deltaswap protocol, you and the Operator
          agree that no developer or entity involved in creating, deploying,
          maintaining, operating this SDK or the Deltaswap protocol, or causing
          ...
          Deltaswap protocol, or this SDK or the Deltaswap protocol themselves,
        ...
        <div>
          You assume all risks associated with using the SDK, the Deltaswap
          ...
          use of the SDK or the Deltaswap protocol. For example, these losses may
