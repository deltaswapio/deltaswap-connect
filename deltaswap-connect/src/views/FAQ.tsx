...
function FAQ() {
  ...
  const FAQs = [
    {
      title: 'What is Deltaswap Connect?',
      content: (
        <>
          Deltaswap Connect is an open source frontend SDK that lets Web3
    ...
    },
    {
      ...
      content: (
        <>
          ...
          Deltaswap Token Bridge will be received as a Deltaswap-wrapped token on
          the destination chain. In some cases, Deltaswap minted tokens are the
          canonical representation on the chain (e.g. WETH on Solana is a
          Deltaswap minted token, see
          <a
            href="https://github.com/deltaswapio/deltaswap-token-list"
            target="_blank"
            rel="noreferrer"
            className={classes.link}
          >
            https://github.com/deltaswapio/deltaswap-token-list
          </a>
          ) and in other cases Deltaswap minted tokens can be swapped on the
    ...
    },
    {
      ...
      content: (
        <>
          Yes, Connect will soon surface multiple Deltaswap-powered services
    ...
    },
    {
      ...
      content: (
        <>
          ...
          Base, Solana and Sui. Connect will support other Deltaswap-connected
          chains and assets in the future, see the full list of Connect
          supported chains on the{' '}
          <a
            href="https://github.com/deltaswapio/deltaswap-connect/blob/development/deltaswap-connect/src/config/mainnet/chains.ts"
            target="_blank"
            rel="noreferrer"
            className={classes.link}
          >
    ...
    },
    {
      ...
      content: (
        <>
          ...
          reach out to Deltaswap's community managers on{' '}
          <a
            href="https://discord.com/invite/deltaswapcrypto"
            target="_blank"
            rel="noreferrer"
            className={classes.link}
          >
